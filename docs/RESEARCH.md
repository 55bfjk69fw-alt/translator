...
| AirPods = output only; replies are spoken by the user from prompter cue cards (docs/REPLY-FLOW.md) | iPadOS single-input rule + field test: push-to-talk went unused |
